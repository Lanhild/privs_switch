--register the `switcher` privilege
minetest.register_privilege("switcher", {
    description = "Can revoke privileges on a timed basis",
...
local function handle_privs_command(caller, name, privstring, grantorrevoke, timestr)
    ...
    local basic_privs = minetest.string_to_privs(minetest.settings:get("basic_privs") or "switcher")
